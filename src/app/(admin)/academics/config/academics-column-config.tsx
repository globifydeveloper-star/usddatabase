...
export const studentColumns = [
    ...
    { id: 'certificate_lt_1yr', name: 'Certificate < 1yr', sort: true, width: '120px' },
    { id: 'certificate_lt_2yr', name: 'Certificate < 2yr', sort: true, width: '120px' },
    { id: 'certificate_lt_4yr', name: 'Certificate < 4yr', sort: true, width: '120px' },
    { id: 'degree_or_certificate', name: 'Degree or Certificate', sort: true, width: '120px' },
