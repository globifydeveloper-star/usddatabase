...
export const metadata: Metadata = { title: 'Solar Icons', other: { subTitle: 'Icons' } }


const SolarIconsCard = ({ title, icon }: SolarIconType) => {
  return (
    <OverlayTrigger trigger={'hover'} placement="top" overlay={<Tooltip>{title}</Tooltip>}>
      <Card>
        <CardBody
          ...
          <Card>
            <CardBody>
              ...
              <p className="mb-4 text-muted">
                Our cutting-edge Solar Iconset boasts an extensive collection of over 7,477 glyphs, encompassing a diverse range of design variants,
                all conveniently packed into a single font file
              </p>
