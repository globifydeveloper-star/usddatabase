...
export const stackedBarChartOpts: ApexOptions = {
  ...
  colors: ['#777edd', '#0acf97', '#fa5c7c', '#45bbe0', '#39afd1'],
  tooltip: {
    y: {
      formatter: function (val) {
        return val + 'K'
...
export const fullStackedBarChartOpts: ApexOptions = {
  ...
  colors: ['#f9bc0b', '#39afd1', '#45bbe0', '#e3eaef', '#777edd'],
  tooltip: {
    y: {
      formatter: function (val) {
        return val + 'K'
...
export const DataLabelsChartOpts: ApexOptions = {
  ...
  colors: ['#777edd', '#0acf97', '#fa5c7c', '#45bbe0', '#39afd1', '#2b908f', '#f9bc0b', '#90ee7e', '#f48024', '#212730'],
  dataLabels: {
    enabled: true,
    textAnchor: 'start',
    style: {
...
export const patternBarChartOpts: ApexOptions = {
  ...
  colors: ['#777edd', '#0acf97', '#fa5c7c', '#39afd1'],
  fill: {
    type: 'pattern',
    opacity: 1,
    pattern: {
