...
const ScatterChart = () => {
  return (
    <ComponentContainerCard title="Scatter (XY) Chart">
      <div dir="ltr">
        <ApexChartClient height={380} options={scatterChartOpts} series={scatterChartOpts.series} type="scatter" className="apex-charts" />
      </div>
...
const ScatterImagesChart = () => {
  return (
    <ComponentContainerCard title="Scatter - Images">
      <div dir="ltr">
        <ApexChartClient height={380} options={scatterImagesChartOpts} series={scatterImagesChartOpts.series} type="scatter" className="apex-charts" />
      </div>
    </ComponentContainerCard>
  )
}
