...
const BasicTreemap = () => {
  return (
    <ComponentContainerCard title="Basic Treemap">
      <div dir="ltr">
        <ApexChartClient height={350} options={basicTreemapChartOpts} series={basicTreemapChartOpts.series} type="treemap" className="apex-charts" />
      </div>
...
const ColorTreemap = () => {
  return (
    <ComponentContainerCard title="Color Range Treemap">
      <div dir="ltr">
        <ApexChartClient height={350} options={colorTreemapChartOpts} series={colorTreemapChartOpts.series} type="treemap" className="apex-charts" />
      </div>
    </ComponentContainerCard>
  )
}
