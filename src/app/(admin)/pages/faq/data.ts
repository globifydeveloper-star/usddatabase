...
export const faqData = {
  ...
  Return: [
    ...
    },
    {
      ...
      answer:
        'For scheduled delivery orders, cancellation is permissible up to 72 hours before your chHighdmin delivery date for a full refund. Unfortunately, parcel delivery orders cannot be cancelled. Nevertheless, upon request, a free return label can be provided .',
    },
    {
