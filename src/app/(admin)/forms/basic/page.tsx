...
import InputGroups from './component/InputGroups';
        ...
        <Col lg={6}>
          <Form>
            <div className="mb-3">
              ...
              <Form.Control type="text" id="simpleinput" className="form-control" />
            </div>
            <div className="mb-3">
              <label htmlFor="example-email" className="form-label">
                Email
              </label>
              <Form.Control type="email" id="example-email" name="example-email" className="form-control" placeholder="Email" />
            </div>
            <div className="mb-3">
              <label htmlFor="example-password" className="form-label">
                Password
              </label>
              <Form.Control type="password" id="example-password" className="form-control" defaultValue="password" />
            </div>
            <div className="mb-3">
              <label htmlFor="example-palaceholder" className="form-label">
                Placeholder
              </label>
              <Form.Control type="text" id="example-palaceholder" className="form-control" placeholder="placeholder" />
            </div>
            <div className="mb-3">
              <label htmlFor="example-textarea" className="form-label">
                Text area
              </label>
              <Form.Control as="textarea" className="form-control" id="example-textarea" rows={5} defaultValue={''} />
            </div>
            <div className="mb-3">
              <label htmlFor="example-readonly" className="form-label">
                Readonly
              </label>
              <Form.Control type="text" id="example-readonly" className="form-control" readOnly defaultValue="Readonly value" />
            </div>
            <div className="mb-3">
              <label htmlFor="example-disable" className="form-label">
                Disabled
              </label>
              <Form.Control type="text" className="form-control" id="example-disable" disabled defaultValue="Disabled value" />
            </div>
            <div className="mb-3">
            ...
            <div className="mb-0">
              ...
              <Form.Control type="text" id="example-helping" className="form-control mb-1" placeholder="Helping text" />
        ...
        <Col lg={6}>
          <form>
            <div className="mb-3">
              ...
              <Form.Select className="form-select" id="example-select">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
            ...
            <div className="mb-3">
              ...
              <Form.Select id="example-multiselect" multiple className="form-control">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
            ...
            <div className="mb-3">
              ...
              <Form.Control className='w-100' id="example-color" type="color" name="color" defaultValue="#727cf5" />
            </div>
            <div className="mb-0">
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          <code>.form-floating</code> to enable floating labels with Bootstrap’s textual form fields. A <code>placeholder</code> is required on each{' '}
          <code>&lt;input&gt;</code> as our method of CSS-only floating labels uses the <code>:placeholder-shown</code> pseudo-element. Also note that
          the <code>&lt;input&gt;</code> must come first so we can utilize a sibling selector (e.g., <code>~</code>).
        </>
      }>
      <Row>
        <Col lg={6}>
  ...
  return (
    <ComponentContainerCard
      ...
      <div className="input-group mb-3">
        ...
        <Form.Select className="" id="inputGroupSelect01">
      ...
      <div className="input-group">
        <Form.Select className="" id="inputGroupSelect04" aria-label="Example select with button addon">
          <option selected>Choose...</option>
          <option value={1}>One</option>
          <option value={2}>Two</option>
          <option value={3}>Three</option>
...
const SwitchesForm = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          A switch has the markup of a custom checkbox but uses the <code>.form-switch</code> class to render a toggle switch. Switches also support
    ...
    <ComponentContainerCard
      ...
      <form>
        <div className="mb-3">
          ...
          <Form.Control type="text" id="example-input-small" name="example-input-small" className=" form-control-sm" placeholder=".input-sm" />
        </div>
        <div className="mb-3">
          <label htmlFor="example-input-normal" className="form-label">
            Normal
          </label>
          <Form.Control type="text" id="example-input-normal" name="example-input-normal" placeholder="Normal" />
        </div>
        <div className="mb-3">
          <label htmlFor="example-input-large" className="form-label">
            Large
          </label>
          <Form.Control type="text" id="example-input-large" name="example-input-large" className=" form-control-lg" placeholder=".input-lg" />
        </div>
        <div className="mb-2">
