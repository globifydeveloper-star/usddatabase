        ...
        <Form>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('booksupply', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('tuition_in_state', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('tuition_out_state', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('tuition_program_year', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('roomboard_oncampus', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('roomboard_offcampus', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('avg_net_price_public', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('avg_net_price_private', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('avg_net_price_overall', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('otherexpense_oncampus', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('otherexpense_offcampus', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleChange('otherexpense_withfamily', e.target.value === '' ? null : Number(e.target.value))
              }
            />
          </Form.Group>
