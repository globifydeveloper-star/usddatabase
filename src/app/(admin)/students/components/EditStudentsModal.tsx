...
const EditStudentsModal = ({ show, onClose, data, onSuccess }: Props) => {
    ...
    const handleChange = (key: keyof Student, value: string | number | null) => {
        setFormData((prev) => ({
            ...prev,
            [key]: value,
        }));
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const url = isEdit ? `/api/students/${data?.unitid}` : `/api/students`;
    ...
    return (
        <Modal show={show} onHide={onClose} centered size="lg">
            <Modal.Header closeButton>
                <Modal.Title>{data ? 'Edit Student Data' : 'Add Student Data'}</Modal.Title>
            </Modal.Header>
            ...
            <Modal.Footer>
                ...
                <Button variant="primary" onClick={handleSave} disabled={loading}>
                    {loading ? 'Saving...' : data ? 'Update Student' : 'Create Student'}
                </Button>
            </Modal.Footer>
