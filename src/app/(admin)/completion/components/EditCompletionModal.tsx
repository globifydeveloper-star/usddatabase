...
const EditCompletionModal = ({ show, onClose, data, onSuccess }: Props) => {
    ...
    const handleChange = (key: keyof Completion, value: string | number | null) => {
        setFormData((prev) => ({
            ...prev,
            [key]: value,
        }));
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const url = isEdit ? `/api/completion/${data?.unitid}` : `/api/completion`;
            ...
            if (result.success) {
                toast.success(
                    isEdit ? 'Completion updated successfully' : 'Completion created successfully'
                );
    ...
    return (
        <Modal show={show} onHide={onClose} centered size="lg">
            <Modal.Header closeButton>
                <Modal.Title>{data ? 'Edit Completion Data' : 'Add Completion Data'}</Modal.Title>
            </Modal.Header>
            ...
            <Modal.Footer>
                ...
                <Button variant="primary" onClick={handleSave} disabled={loading}>
                    {loading ? 'Saving...' : data ? 'Update Completion' : 'Create Completion'}
                </Button>
            </Modal.Footer>
