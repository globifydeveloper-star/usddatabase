...
export const metadata: Metadata = { title: 'List Group', other: { subTitle: 'Base UI' } }
      ...
      <BSListGroup as={'ol'} className="list-group-numbered">
        <ListGroupItem className="d-flex justify-content-between align-items-start">
          <div className="ms-2 me-auto">
            <div className="fw-bold">Highdmin Admin</div>
            Highdmin Admin
          </div>
        ...
        <ListGroupItem className="d-flex justify-content-between align-items-start">
          <div className="ms-2 me-auto">
            <div className="fw-bold">Highdmin React Admin</div>
