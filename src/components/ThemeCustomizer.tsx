          ...
          <Col xs={4} key={item.mode + idx}>
            <div className="form-check card-radio">
              ...
              <label className="form-check-label p-3 w-100 d-flex justify-content-center align-items-center" htmlFor={`layout-color-${item.mode}`}>
                <div className="check-icon">{item.mode === theme && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}</div>
        ...
        <Col xs={4}>
          <div className="form-check card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor={`layout-mode-fluid`}>
              {layoutMode === 'fluid' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
              <div>
        ...
        <Col xs={4}>
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="data-layout-detached">
              {layoutMode === 'detached' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
              <span className="d-flex h-100 flex-column">
          ...
          <Col xs={3} key={idx}>
            <div className="form-check card-radio">
              ...
              <label className="form-check-label p-0 avatar-lg w-100 bg-light" htmlFor={`topbar-color-${mode}`}>
                <div className="check-icon">{topbarTheme === mode && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}</div>
          ...
          <Col xs={3} key={idx}>
            <div className="form-check sidebar-setting card-radio">
              ...
              <label className="form-check-label p-0 avatar-lg w-100 bg-light" htmlFor={`sidenav-color-${mode}`}>
                <div className="check-icon">{theme === mode && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}</div>
                <span className="d-flex align-items-center justify-content-center h-100">
                  <span
                    className={`p-2 d-inline-flex shadow rounded-circle bg-${mode == 'brand' ? 'primary' : mode == 'light' ? 'white' : 'dark'}`}
                  />
          ...
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-default">
              <span className="d-flex h-100">
                ...
                <span className="flex-grow-1">
                  <div className="check-icon">
                    {menuSize === 'default' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
                  </div>
                  <span className="d-flex h-100 flex-column">
                    <span className="bg-light d-block p-1" />
                  </span>
          ...
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-compact">
              <span className="d-flex h-100">
                ...
                <span className="flex-grow-1">
                  <div className="check-icon">
                    {menuSize === 'compact' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
                  </div>
                  <span className="d-flex h-100 flex-column">
                    <span className="bg-light d-block p-1" />
                  </span>
          ...
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-small">
              <span className="d-flex h-100">
                ...
                <span className="flex-grow-1">
                  <div className="check-icon">
                    {menuSize === 'condensed' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
                  </div>
                  <span className="d-flex h-100 flex-column">
                    <span className="bg-light d-block p-1" />
                  </span>
          ...
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-small-hover">
              <span className="d-flex h-100">
                ...
                <span className="flex-grow-1">
                  <div className="check-icon">
                    {menuSize === 'sm-hover' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
                  </div>
                  <span className="d-flex h-100 flex-column">
                    <span className="bg-light d-block p-1" />
                  </span>
        ...
        <Col xs={4}>
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-full">
              <div className="check-icon">{menuSize === 'full' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}</div>
              <span className="d-flex h-100">
                <span className="flex-shrink-0">
                  <span className="d-flex h-100 flex-column">
        ...
        <Col xs={4}>
          <div className="form-check sidebar-setting card-radio">
            ...
            <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-fullscreen">
              <div className="check-icon">
                {menuSize === 'fullscreen' && <IconifyIcon icon="tabler:circle-check-filled" className="check-icons" />}
              </div>
              <span className="d-flex h-100">
                <span className="flex-grow-1">
                  <span className="d-flex h-100 flex-column">
